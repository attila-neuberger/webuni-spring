...
import hu.comtur.airport.service.NonUniqueIataException;
...
public class CustomExceptionHandler {
	...
	public ResponseEntity<MyError> handleValidation(MethodArgumentNotValidException e, WebRequest req) {
		log.warn(e.getMessage(), e);
