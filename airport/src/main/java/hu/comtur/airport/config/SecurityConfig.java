...
import hu.comtur.airport.security.JwtAuthFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		// Database authentication (authentication provider):
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			// .httpBasic() // JWT authentication instead of this
			// .and()
			.csrf().disable()
			.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS) // stateless mode
			.and()
			.authorizeRequests()
