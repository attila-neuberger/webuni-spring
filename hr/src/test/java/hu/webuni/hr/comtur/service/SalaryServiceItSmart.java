...
public class SalaryServiceItSmart {
	...
	Employee employee1 = new Employee(1L, "Name", "Position", 1000, LocalDateTime.of(2022, 1, 1, 0, 0)); // 0%
	Employee employee2 = new Employee(2L, "Name", "Position", 1000, LocalDateTime.of(2019, 1, 1, 0, 0)); // 2%
	Employee employee3 = new Employee(3L, "Name", "Position", 1000, LocalDateTime.of(2010, 1, 1, 0, 0)); // 50%
